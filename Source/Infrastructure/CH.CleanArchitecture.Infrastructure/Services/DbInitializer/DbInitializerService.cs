    ...
    internal class DbInitializerService : IDbInitializerService
    {
        ...
        public void Seed() {
            ...
            var applicationConfigurations = new ApplicationConfigurationEntity[] {
                    ...
                    new ApplicationConfigurationEntity { Id = AppConfigKeys.AZURE.STORAGE_ACCOUNT_NAME, Value = "{enter storage account service endpoint}", Description = "The Azure Storage account service endpoint. Used if passwordless authentication is enabled."},
