    ...
    internal class DbInitializerService : IDbInitializerService
    {
        ...
        public void Seed() {
            ...
            var applicationConfigurations = new ApplicationConfigurationEntity[] {
                    ...
                    new ApplicationConfigurationEntity { Id = AppConfigKeys.CACHE.SLIDING_EXPIRATION_TIME, Value = "15", Description = "The default sliding expiration time (in seconds) for the cache"},
                    new ApplicationConfigurationEntity { Id = AppConfigKeys.CACHE.KEY_PREFIX, Value = "Dev", Description = "The prefix of the generate cache keys. Use 'Dev' for dev environment and 'Prod' for production environment"}
                };
