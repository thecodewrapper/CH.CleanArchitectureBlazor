...
namespace CH.CleanArchitecture.Infrastructure.DbContexts
{
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, IIdentityContext identityContext) : base(options) {
        ...
        public override int SaveChanges(bool acceptAllChangesOnSuccess) {
            DbContextUpdateOperations.UpdateDates(ChangeTracker.Entries<AuditableEntity>(), _identityContext.Username);
            this.EnsureAuditHistory(_identityContext.Username);
