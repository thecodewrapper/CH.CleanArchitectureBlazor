...
namespace CH.CleanArchitecture.Infrastructure.Migrations.Application
{
    ...
    [Migration("20250807055850_EnhancedNotificationEntity")]
    partial class EnhancedNotificationEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CH.CleanArchitecture.Infrastructure.Models.NotificationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CH.CleanArchitecture.Infrastructure.Models.ResourceEntity", b =>
                {
                    b.Property<string>("Id")
            ...
            modelBuilder.Entity("CH.CleanArchitecture.Infrastructure.Models.OrderEntity", b =>
                {
                    b.HasOne("CH.CleanArchitecture.Infrastructure.Models.AddressEntity", "BillingAddress")
                        .WithOne()
                        .HasForeignKey("CH.CleanArchitecture.Infrastructure.Models.OrderEntity", "BillingAddressId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CH.CleanArchitecture.Infrastructure.Models.AddressEntity", "ShippingAddress")
                        .WithOne()
                        .HasForeignKey("CH.CleanArchitecture.Infrastructure.Models.OrderEntity", "ShippingAddressId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
