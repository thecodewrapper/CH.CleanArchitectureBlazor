...
namespace CH.CleanArchitecture.Core.Application
{
    public interface IApplicationUserService
    {
        ...
        /// <returns></returns>
        Task<Result> CreateUserAsync(User user, string password, List<string> roles);

        /// <summary>
        /// Deletes an existing user with the id specified by <paramref name="userId"/>
        /// </summary>
        ...
        /// <summary>
        /// Directly sets the email confirm flag of the user to true.
        /// CAUTION: This will manually set the user email as confirmed, without any validation of the token.
        /// If you need to validate the token first, use <see cref="ConfirmUserEmailAsync(string, string)"/>
        /// </summary>
        /// <param name="userId"></param>
        /// <returns></returns>
        Task<Result> ConfirmUserEmailAsync(string userId);
